...
void ChessView::movePiece(int srow, int scol, int erow, int ecol)
{
  on_CellSelected(srow, scol, 1);
  on_CellSelected(erow, ecol, 1);
}
...
void ChessView::run()
{
  ...
  // select a piece then do an undo
